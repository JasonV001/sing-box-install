...
configure_argo() {
    ...
    echo -e "${CYAN}╚═══════════════════════════════════════════════════════════╝${NC}"
    echo ""
    echo -e "  ${PURPLE}【安装方式】${NC}"
    echo -e "    ${GREEN}1.${NC}  Quick Tunnel       ${YELLOW}(临时域名 - 快速)${NC}"
    echo -e "    ${GREEN}2.${NC}  Token 认证         ${YELLOW}(固定域名 - 推荐)${NC}"
    echo -e "    ${GREEN}3.${NC}  JSON 认证          ${YELLOW}(完整配置)${NC}"
    echo ""
    echo -e "  ${PURPLE}【管理功能】${NC}"
